    ...
    <div class="flex space-x-6 filters">
        ...
        <div class="w-1/3">
            <select name="other_filters" id="other_filters" class="w-full px-4 py-2 border-none rounded-xl">
                <option value="Filtre One">Filtre 1</option>
                <option value="Filtre two">Filtre 2</option>
                ...
                <div class="mx-4">
                    ...
                    <div class="flex items-center justify-between mt-6">
                        ...
                        <div class="flex items-center space-x-2">
                            ...
                            <button
                                class="relative px-4 py-2 transition duration-150 ease-in bg-gray-100 rounded-full hover:bg-gray-200 h-7">&bull;&bull;&bull;

                                <ul
                                    class="absolute w-64 py-3 ml-8 font-semibold text-left bg-white shadow-dialog rounded-xl">
                                    <li>
                                        <a href="#"
