<form wire:submit.prevent="createIdea" action="#" method="post" class="px-4 py-6 space-y-4 ">
    <div>
        <input wire:model.defer="title" type="text" class="w-full px-4 py-2 text-sm placeholder-gray-900 bg-gray-100 border-none rounded-xl" placeholder="Votre idée">
    </div>
    <div>
        <select wire:model.defer="category" name="category_add" id="category_add" class="w-full px-4 py-2 bg-gray-100 border-none rounded-xl">
    ...
    <div>
        <textarea wire:model.defer="description" name="idea" id="idea" cols="30" rows="4" class="w-full px-4 py-2 text-sm placeholder-gray-900 bg-gray-100 rounded-xl" placeholder="Description"></textarea>
    </div>
